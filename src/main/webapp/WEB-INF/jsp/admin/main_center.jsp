...
<label><a href="<c:url value="/admin/follower"/> ">关注我的</a> </label><br/>
<label><a href="<c:url value="/admin/star/list"/> ">我的收藏</a> </label><br/>
<label><a href="<c:url value="/square"/> ">广场</a> </label><br/>
</body>
</html>
